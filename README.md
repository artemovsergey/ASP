...
### ViewModel
Правильно использовать строгую типизацию представлений. Сейчас наше представление знает какой тип модели ожидается о контроллера. Но используя три штуки выше, наше представление теряет строгую типизацию.  Лучше всего использовать viewModel.
