...
- Put
```cmd
Invoke-RestMethod https://localhost:7091/api/products/1425 -Method Put -Body (@{Id=1425;Name="1";Description="1";PurchasePrice=3;RetailPrice=1;CategoryId=141}    | ConvertTo-Json) -ContentType "application/json"
```
