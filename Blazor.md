...
требуют использовать верблюжье написание для свойств. Давайте посмотрим, как мы можем управлять этим с помощью
Листинг 7-8. Чтобы изменить регистр, можно установить свойство PropertyNamingPolicy.
...
как "Spicy". Для этого используйте конвертер JsonStringEnumConverter, как показано в листинге 7-8. Не
